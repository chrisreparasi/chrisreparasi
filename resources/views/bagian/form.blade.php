    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 text-center">
          <h2>Beri Kami Pesan!</h2>
          <p class="text-white">Anda sudah pernah mereparasi barang di tempat kami? <br> Beri tanggapan berbentuk kesan pesan untuk mendukung kami menjadi lebih baik.</p>
          <hr>
        </div>
      </div>
