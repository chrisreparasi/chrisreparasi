      ...
      <h1 class="display-5">Cek <span>status barang</span> anda di sini</h1>
        <div class="row justify-content-center">
          <div class="col-sm-12">
            ...
            @csrf
              <input type="text" name="q" class="form-control d-inline" placeholder="Masukkan ID Barang Anda" style="width: 90%;">
              <button type="submit" class="btn tombol d-inline ml-3" style="width: 5%;">Cari</button>
            </form>
          </div>
        </div>
    </div>
